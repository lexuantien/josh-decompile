...
const TableOfContents = ({
    ...
    return ( <
        Wrapper >
        <
        TocHeading forwardedAs = "h2"
        type = "section-title" >
        Table of Contents <
        /TocHeading>

        <
        ContentLinkHeading href = "#introduction"
        style = {
            getStylesForDepth(1, !activeHeadingId)
        } >
        Introduction <
        /ContentLinkHeading>
...
const useActiveHeading = (headings) => {
    ...
    React.useEffect(() => {
        const handleScroll = throttle(() => {
            ...
            let firstHeadingInViewport = headingBoxes.find(({
                box
            }) => {
                return (
            ...
            if (!firstHeadingInViewport) {
                ...
                firstHeadingInViewport = reversedBoxes.find(({
                    box
                }) => {
