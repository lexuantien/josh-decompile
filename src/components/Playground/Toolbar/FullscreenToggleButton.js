...
const FullscreenToggleButton = ({
    ...
    return ( <
        ...
        id = {
            isFullscreened ? 'fs-wrapper' : undefined
        } >
        <
        Svg viewBox = "0 0 16 16"
        fill = "none" >
        <
        animated.path d = "M2 6 L 2 2 L 6 2"
        style = {
            path1
        }
        /> <
        animated.path d = "M10 2 L 14 2 L 14 6"
        style = {
            path2
        }
        /> <
        animated.path d = "M14 10 L 14 14 L 10 14"
        style = {
            path3
        }
        /> <
        animated.path d = "M6 14 L 2 14 L 2 10"
        style = {
            path4
        }
        /> <
