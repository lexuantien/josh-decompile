...
function NavUnderline({
    ...
    switch (size) {
        case 'short':
            return <Short strokeColor = {
                strokeColor
            }
            />;
        case 'medium':
            return <Medium strokeColor = {
                strokeColor
            }
            />;
        case 'long':
            return <Long strokeColor = {
                strokeColor
            }
            />;
...
const Short = ({
    ...
    fill = "none" >
    <
    path d = "M1 5.39971C7.48565 -1.08593 6.44837 -0.12827 8.33643 6.47992C8.34809 6.52075 11.6019 2.72875 12.3422 2.33912C13.8991 1.5197 16.6594 2.96924 18.3734 2.96924C21.665 2.96924 23.1972 1.69759 26.745 2.78921C29.7551 3.71539 32.6954 3.7794 35.8368 3.7794"
    stroke = {
        strokeColor
    }
    strokeWidth = "2"
...
`
  & path {
    @media (prefers-reduced-motion: no-preference) {
      ...
      animation: ${dash} 500ms 250ms cubic-bezier(0.27, 0.22, 0.44, 1.03) both;
    }
  }
`;
